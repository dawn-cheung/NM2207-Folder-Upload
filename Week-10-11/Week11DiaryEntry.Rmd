...
concepts <- tibble(
  ...
  conceptTaught = c("knitr::include_graphics()", "Manipulation of csv data", "Variable manipulation", "The concept of filtering! Especially for data cleaning & tidying", "Functions, because many of the plotting code is repettitive", "", "The concept of interactive pages and copying code but knowing what to change", "how to plot maps, how to make tables"),
)
...
#The following are the placeholders i will put in the website
library(tidyverse)
library(ggplot2)
library(maps)
library(sf)
